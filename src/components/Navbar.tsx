...
/**
 * @component Navbar
 * @description Global navigation bar with responsive layout, authentication
 * controls, and accessible navigation landmark.
 */
  ...
  return (
    ...
    >
      <div className="container mx-auto px-4 h-16 flex items-center justify-between">
        <Link href="/" className="flex items-center gap-2" aria-label="EcoTrack AI — Go to homepage">
